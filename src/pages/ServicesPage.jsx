...
const ServiceCard = ({ service, index }) => {
  ...
  return (
    ...
    >
      <div
        className={`glass-panel rounded-3xl p-3 md:p-6 border border-white/5 hover:border-white/20 transition-all duration-500 h-full ${service.gradient} backdrop-blur-xl relative overflow-hidden hover:scale-[1.02] cursor-pointer`}
      >
        {/* Glow Effects */}
        ...
        <div className=" relative z-10 md:mb-4">
          ...
          <h3 className="text-xl font-bold text-white md:mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-linear-to-r group-hover:from-neon-purple group-hover:to-blue-400 transition-all duration-300">
            {service.title}
          </h3>
  ...
  return (
    <div className="min-h-screen bg-background-dark text-slate-200 relative overflow-hidden selection:bg-neon-purple selection:text-white">
      ...
      <div className="relative z-10">
        ...
        <section className="md:py-12 px-4 sm:px-6 max-w-7xl mx-auto">
          ...
          >
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-5">
              <div>
                <h2 className="text-center md:text-start text-2xl md:text-3xl font-bold text-white mb-2">
        ...
        {/* SERVICES GRID */}
        <section className=" md:pb-15 px-4 sm:px-6 max-w-7xl mx-auto">
        ...
        {/* BENEFITS SECTION */}
        <section className="py-5 md:py-24 px-4 sm:px-6">
